...
# CHECKPOINT_DIR = "/mnt/spark-checkpoints/tx-checkpoints"
# STATES_DIR = "/mnt/spark-state/tx-state"
...
print(f'Spark Session Creation Successful! {spark}')
...
transactions_df = transactions_df.withColumn('transactionTimestamp', (col('transactionTime')/1000).cast("timestamp"))
